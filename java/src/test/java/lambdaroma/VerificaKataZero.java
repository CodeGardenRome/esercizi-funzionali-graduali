...
public class VerificaKataZero {
    ...
    public void verifica(KataZeroInterfaccia daVerificare){
        ...
        assertEquals(Arrays.asList(7,14,21,28,35,42,49,56,63,70), daVerificare.kataZeroC());
        assertEquals(Arrays.asList("Caio","Calpurnio"), daVerificare.kataZeroD());
        assertEquals(new Double(44), daVerificare.kataZeroE());
        assertEquals(330, daVerificare.kataZeroF());
